...
function show(){
	...
	<div>\
		...
		<img id="drag4" src="images/not.gif" width="100px" height="60px" draggable="true" ondragstart="drag(event);myid(this.id);" width="336" height="69">\
	</div>';
}
